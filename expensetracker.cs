        ...
        switch (action) {
            ...
            case "continue":
                ...
                if (i > 0 && earned != 0)
                {
                    ...
                    Console.WriteLine($"Your total expenses come out to be: {products.Sum(kv => kv.Value[0] * kv.Value[1])} ");         // adding a new product to the list, including its cost
                    ...
                    {
                        Console.WriteLine($"Your current balance is: {earned - products.Sum(kv => kv.Value[0] * kv.Value[1])}");
                    }
                }
                else
                {
